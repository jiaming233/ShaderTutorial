Shader "Tutorial/01_Basic_Unlit"{
    ...
    Properties{
      ...
      _MainTex("Texture", 2D) = "white" {}
        ...
        Pass{
          ...
          sampler2D _MainTex;
          float4 _MainTex_ST;//_ST : scale and transform, or tiling and offset
          ...
          //SV_Target tell the compiler that the output is used as the color.
